...
<p><h3>Selamat datang, NORAZMI BIN MOHD. ARSHAD</h3>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>NO.10, LALUAN 5, HALAMAN MERU PERMAI ,
BANDAR MERU RAYA, 30020 IPOH, PERAK</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>wfd9559@gmail.com</td>
      </tr>
    </table>
