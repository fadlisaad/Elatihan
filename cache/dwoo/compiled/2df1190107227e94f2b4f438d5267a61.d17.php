...
<title>Log Keluar | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/logout" />
...
<script>window.location.href = 'http://elearn.mardi.gov.my'</script>
<p>Anda telah log keluar dari sistem ini. Terima kasih.</p>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
