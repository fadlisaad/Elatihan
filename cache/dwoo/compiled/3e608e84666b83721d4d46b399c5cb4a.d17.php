...
<div class='notification information'><p>Pendaftaran dalam kursus Pemprosesan Hasilan Makanan Sejuk Beku (pau, karipaf, kasturi)</p></div><table border="0" cellpadding="4" cellspacing="0">
<tr>
...
<td>Jenis</td><td>Kursus Berjadual</td></tr>
		...
		<input name="peserta_id" type="hidden" value="458" />
		<input name="kursus_id" type="hidden" value="202" />
		<input name="lastupdate" type="hidden" value="2010-09-24" />
...
<br /><input type="submit" name="daftar" value="Sahkan Pendaftaran" id="daftar" class="button"  /></form>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>Wan Sulaiman Bin Wan Ahmad</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
