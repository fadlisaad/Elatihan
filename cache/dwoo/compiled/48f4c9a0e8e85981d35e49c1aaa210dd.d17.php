...
<p>Status permohonan kursus anda dalam kursus berkenaan adalah betul semasa tarikh 13-10-2010. Jika terdapat sebarang perubahan, pihak pentadbir kursus akan memaklumkan kepada anda.</p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>NOOR AZLINA BINTI MOHAMAD</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
