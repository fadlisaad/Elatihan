...
<p><h3>Selamat datang, NORHAFEZZA BINTI KHAMIS</h3>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>NO.28, JLAN TIB 2/8, TAMAN INDUSTRI BOLTON, 68100 BATU CAVES, SELANGOR DARUL EHSAN</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>fie_berry_girl@yahoo.com</td>
      </tr>
    </table>
