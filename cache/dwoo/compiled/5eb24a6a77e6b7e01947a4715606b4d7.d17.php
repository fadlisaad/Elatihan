...
<title>user daftar exec | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/user-daftar-exec" />
...
<div class='notification failure'><p>Kursus yang anda pilih telah ada dalam <a href='keterangan-pendaftaran'>senarai kursus berdaftar</a> anda</p></div>Sila pilih kursus lain. Klik pada pautan Kursus Berjadual pada menu sebelah kanan ini.						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
