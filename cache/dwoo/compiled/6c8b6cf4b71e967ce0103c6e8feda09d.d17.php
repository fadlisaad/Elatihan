...
<p><h3>Selamat datang, AHMAD B. TALALO</h3>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>NO 40 KG SUNGAI MERBAH, SIMPANG RENGGAM JOHOR</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>eid_ironlady@yahoo.com</td>
      </tr>
    </table>
...
<h3>Maklumat Majikan</h3>
  ...
  <tr>
    ...
    <td>REXWELL SDN BHD</td>
  </tr>
  <tr>
    <td width="150"><label>Alamat</label></td>
    <td>NO 23, JALAN KURMA, SIMPANG RENGGAM, JOHOR</td>
  </tr>
  <tr>
