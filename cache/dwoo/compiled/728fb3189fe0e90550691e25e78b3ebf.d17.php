...
<title>Pendaftaran Kursus | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/user-daftar" />
...
<div class='notification information'><p>Pendaftaran dalam kursus Pemprosesan Snek Ikan (keropok lekor, keropok kering, keropok segera)</p></div><table border="0" cellpadding="4" cellspacing="0">
<tr>
<th>Kod</th><th>00043</th></tr>
<tr>
...
<td>Jenis</td><td>Kursus Luar Jadual</td></tr>
		...
		<input name="peserta_id" type="hidden" value="480" />
		<input name="kursus_id" type="hidden" value="107" />
		<input name="lastupdate" type="hidden" value="2010-10-06" />

<br /><input type="submit" name="daftar" value="Sahkan Pendaftaran" id="daftar" class="button"  /></form>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
