...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/modul" />
...
<p>Kursus yang ditawarkan berdasarkan empat kluster utama iaitu:</p>
<ul>
<li><a href="#tanaman">Kluster teknologi tanaman </a></li>
<li><a href="#ternakan">Kluster teknologi ternakan </a></li>
<li><a href="#makanan">Kluster teknologi makanan</a> </li>
<li><a href="#lanjutan">Kluster teknologi lanjutan</a></li>
</ul>
<p>&nbsp;</p>
<p>Sebahagian contoh kursus yang ditawarkan mengikut kluster ialah:</p>
<h3><a name="tanaman"></a>Kluster Teknologi Tanaman</h3>
<ul>
<li>Pengeluaran Dan Pengendalian Lepas Tuai Nanas</li>
<li>Landskap Taman</li>
<li>Pengeluaran Sayur- Sayuran Secara Fertigasi</li>
<li>Landskap Dan Simenfero</li>
<li>Pengurusan Penyakit Dan Perosak Pada Herba Terpilih</li>
<li>Pemeliharaan Serangga Secara Besar- Besaran (untuk kawalan biologi  dan sumber protein)</li>
<li>Sistem Pengairan Mikro Dan Pemercik (sprinkler)</li>
<li>Pengeluaran Sayur-Sayuran Secara Organik</li>
<li>Crest Ferto : Sistem Bantu Buat Keputusan Pengurusan Tanaman Padi</li>
</ul>
<h3><a name="ternakan"></a>Kluster Teknologi Ternakan</h3>
<ul>
<li>Penternakan Kambing Boer Secara Komersial</li>
<li>Penternakan Ayam Kampung Dan Ayam Pedaging</li>
<li>Penternakan Kambing Biri- Biri Secara Komersial </li>
<li>Pengurusan Lembu Pedaging Secara Fidlot </li>
<li>Pemprosesan Makanan Ternakan Berasaskan Sisa Tanaman Berserabut  Tinggi</li>
</ul>
<h3><a name="makanan"></a>Kluster Teknologi Makanan</h3>
<ul>
<li>Teknologi Pemprosesan Pes Dan Perencah</li>
<li>Pemprosesan Hasilan Bakeri(roti, pastri, kek, cookies)</li>
<li>Pemprosesan Produk Berasaskan Nanas</li>
<li>Pemprosesan Produk Daging&nbsp; (nuget, burger, sosej</li>
<li>Pemprosesan Hasilan Surimi </li>
<li>Pemprosesan Jeruk Buah- Buahan</li>
<li>Pemprosesan Sos Buah- Buahan (sos buah bercili, sos dessert)</li>
<li>Teknologi Pemprosesan&nbsp; Produk Salai (ikan salai, franfurters, sosej  ikan sejukbeku)</li>
<li>Pemprosesan Hasilan Makanan Sejuk Beku Kuih Tradisional (pau,  karipaf, kasturi)</li>
<li>Pemprosesan Snek Bergoreng (maruku, kerepek bawang, rempeyek) </li>
<li>Pemprosesan Kordial, Jus Dan Minuman Terus Buah- Buahan</li>
</ul>
<h3><a name="lanjutan"></a>Kluster Teknologi Lanjutan</h3>
<ul>
<li>Pra- syarat Kepada Implementasi HACCP</li>
<li>Pembiakan Tanaman Pisang Secara Kultur Tisu</li>
<li>Ke Arah Penghasilan Makanan Halal</li>
<li>HACCP And Its Implementation</li>
<li>Good Hygiene Practices (GHP) Dalam Industri Pemprosesan Makanan</li>
<li>Good Manufacturing Practices (GMP) Untuk Industri Pemprosesan  Makanan </li>
<li>HACCP &ndash; Verification and Auditing </li>
<li>Pembiakan Tanaman Orkid dan Pisang Secara Kultur Tisu</li>
<li>Pembungkusan dan Pelabelan Makanan</li>
</ul>
<p>&nbsp;</p>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
