...
<p><h3>Selamat datang, SITI NUR SHAFARA BINTI MUHAMAD</h3>
...
<h3>Maklumat Peribadi</h3>
      ...
      <tr>
        ...
        <td>SITI NUR SHAFARA BINTI MUHAMAD</td>
      </tr>
      <tr>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>NO.2, LOT 3584, LORONG HJ. TAIB,
OFF JALAN KEBUN, 
SEKSYEN 32, 42435, 
SHAH ALAM, SELANGOR</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>ashaz_etikatrade@yahoo.com</td>
      </tr>
    </table>
...
<p>Sila pastikan segala maklumat yang telah dimasukkan adalah tepat. Klik 'Log Keluar' untuk keluar dari halaman ini.</p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>Siti Nur Shafara Binti Muhamad</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
