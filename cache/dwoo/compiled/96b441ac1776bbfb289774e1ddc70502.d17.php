...
<title>Penafian | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/penafian" />
...
<p>MARDI tidak bertanggungjawab terhadap sebarang kehilangan atau kerugian  yang dialami kerana menggunakan mana-mana maklumat yang diperolehi dari  laman web ini.</p>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
