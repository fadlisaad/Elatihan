...
<title>Dasar Privasi | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/dasar-privasi" />
...
<h3>Privasi anda</h3>
<p>Halaman ini menerangkan dasar privasi yang merangkumi penggunaan dan  perlindungan maklumat yang dikemukan oleh pengunjung.</p>
...
<h3>Apa yang akan Berlaku jika Saya Membuat Pautan kepada Laman Web yang  Lain?</h3>
...
<h3>Pindaan Dasar</h3>
<p>Sekiranya dasar privasi ini dipinda, pindaan akan dikemas kini di  halaman ini. Dengan sering melayari halaman ini, anda akan dikemas kini  dengan maklumat yang dikumpul, cara ia digunakan dan dalam keadaan  tertentu, bagaimana maklumat dikongsi bersama pihak yang lain</p>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
