...
<div class='notification information'><p>Pendaftaran dalam kursus Pre-requisite To HACCP Implementation</p></div><table border="0" cellpadding="4" cellspacing="0">
<tr>
...
<td>Jenis</td><td>Kursus Luar Jadual</td></tr>
		...
		<input name="peserta_id" type="hidden" value="341" />
		<input name="kursus_id" type="hidden" value="84" />
...
<br /><input type="submit" name="daftar" value="Sahkan Pendaftaran" id="daftar" class="button"  /></form>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>SHARIFAH BINTI ABDUL JAMIL</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
