...
<p><h3>Selamat datang, ARIFF HAKIMI BIN ABDUL RAHIM</h3>
...
<h3>Maklumat Peribadi</h3>
      ...
      <tr>
        ...
        <td>ARIFF HAKIMI BIN ABDUL RAHIM</td>
      </tr>
      <tr>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>94, JALAN PIPIT 1,
OFF LEBUHRAYA SULTANAH BAHIYAH,
05350, ALOR SETAR,
KEDAH.</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>hakimi8286@yahoo.com</td>
      </tr>
    </table>
...
<p>Sila pastikan segala maklumat yang telah dimasukkan adalah tepat. Klik 'Log Keluar' untuk keluar dari halaman ini.</p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>ARIFF HAKIMI BIN ABDUL RAHIM</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
