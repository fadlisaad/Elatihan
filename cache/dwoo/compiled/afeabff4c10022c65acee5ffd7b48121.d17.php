...
<title>Maklumat Umum | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/maklumat-umum" />
...
<h3>MANFAAT KURSUS KEPADA KLIEN</h3>
<p>Memperoleh pengetahuan dan kemahiran dalam teknologi pengeluaran tanaman dan ternakan, pengendalian lepas tuai tanaman dan pemprosesan produk makanan.Yakin dan mampu mengusahakan serta meningkatkan mutu hasil pengeluaran produk.</p>
<h3>KELAYAKAN PEMOHON</h3>
<ul>
<li>Warganegara Malaysia dan luar negara</li>
<li>Berumur 18- 60 tahun</li>
<li>Telah tamat pendidikan menengah (syarat minimum)*</li>
</ul>
<h3>BAHASA PENGANTAR</h3>
<p>Bahasa Malaysia Bahasa Inggeris</p>
<blockquote>
<p>Nota: Jika tajuk kursus adalah dalam Bahasa Inggeris, maka kursus  akan dijalankan dalam Bahasa Inggeris. Pemilihan peserta adalah berdasarkan kriteria dan budi bicara pihak penganjur</p>
</blockquote>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
