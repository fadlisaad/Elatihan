...
<h3>Selamat datang, Zahiah NurulJannah Bt Halil@Khalil (libraries_jenny88@yahoo.com)</h3>
...
<p>Status permohonan kursus anda dalam kursus berkenaan adalah betul semasa tarikh 11-09-2010. Jika terdapat sebarang perubahan, pihak pentadbir kursus akan memaklumkan kepada anda.</p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>Zahiah NurulJannah Bt Halil@Khalil</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
