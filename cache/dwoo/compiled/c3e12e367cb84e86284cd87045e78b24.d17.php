<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><h3>Selamat datang, MOHD FADLI SAAD (apad.net@gmail.com)</h3>	
<form method="POST" action="user-edit-exec" name="update" id="update" class="ajax_form">
    <input type="hidden" name="ic" id="ic" value="820115016285"/>
	
	<div class="notification information"><p>Ubah maklumat peribadi dan biodata</p></div>
	
    <h3>Maklumat Peribadi</h3>
		<p>
			<input name="name" type="text" class="text_input" value="MOHD FADLI SAAD"/>
			<label>Nama Penuh</label>
		</p>
		<p>
			<input name="ic" type="text" class="text_input" value="820115016285"/>
		...
		<p>
			<input name="umur" type="text" class="text_input" value="28" maxlength="2"/>
			<label>Umur</label>
		</p>
	 
    <h3>Maklumat Untuk Dihubungi</h3>
		<p>
			<input name="tel_bimbit" type="text" class="text_input" id="tel_bimbit" value="+60123456789"/>
			<label>No. Telefon Bimbit</label>
		</p>
		<p>
			<input name="tel_pej_rumah" type="text" class="text_input" id="tel_pej_rumah" value="+6064511256" />
			<label>No.Telefon Rumah</label>
		</p>
		<p>
			<textarea name="address" cols="40" rows="5" class="text_input" id="address">CASMARIA APARTMENT, JALAN SAMUDRA UTAMA, TAMAN SAMUDRA 61800 BATU CAVES SELANGOR</textarea>
			<label>Alamat Rumah</label>
		</p>
		<p>
			<input name="email" type="text" class="text_input" id="email" value="apad.net@gmail.com" />
			<label>E-mail</label>
		</p>
	...
	<h3>Maklumat Lain</h3>
		<p>
			...
			<input checked="checked" type="radio" name="taraf" id="taraf" value="bujang" />Bujang<br />
		...
		<p>
			...
			<option value="sarjana muda" selected="selected">Ijazah Sarjana Muda</option>
		...
		<p>
			<input name="perusahaan" type="text" class="text_input" id="perusahaan" value="KOMPUTER ITS" />
			<label>Bidang</label>
		</p>
	
	<h3>Maklumat Majikan</h3>
		<p>
			<input name="m_nama" type="text" class="text_input" id="m_nama" value="APADMEDIA RESOURCES" />
			<label>Majikan</label>
		</p>
		<p>
			<textarea name="m_alamat" cols="40" rows="5" class="text_input" id="m_alamat">P.O BOX 252 GOMBAK 53800 KUALA LUMPUR</textarea>
			<label>Alamat</label>
		</p>
		<p>
			<input name="m_telefon" type="text" class="text_input" id="m_telefon" value="361876945" />
