...
<title>Halaman Pengguna | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/halaman-pengguna" />
...
<p><h3>Selamat datang, HARINI BINTI HJ. IBRAHIM</h3>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>NO.1 BLOK A RUMAH MURAH SUNGAI UDANG 2, 41100 KLANG SELANGOR</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>hariniibrahim@yahoo.com</td>
      </tr>
    </table>
...
<h3>Maklumat Majikan</h3>
  ...
  <tr>
    ...
    <td>MAJLIS AMANAH RAKYAT</td>
  </tr>
  <tr>
    <td width="150"><label>Alamat</label></td>
    <td>MAJLIS AMANAH RAKYAT
BAHAGIAN SUMBER MANUSIA
TINGKAT 17 & 18, IBU PEJABAT MARA
21, JALAN RAJA LAUT
50609 KUALA LUMPUR</td>
  </tr>
  <tr>
...
</p>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
