...
<div class='notification information'><p>Pendaftaran dalam kursus Pemprosesan Hasilan Soya (susu,taufufah,tauhu)</p></div><table border="0" cellpadding="4" cellspacing="0">
<tr>
...
<td>Jenis</td><td>Kursus Luar Jadual</td></tr>
		...
		<input name="peserta_id" type="hidden" value="504" />
...
<br /><input type="submit" name="daftar" value="Sahkan Pendaftaran" id="daftar" class="button"  /></form>						</div><p><input name="back" value="Kembali" class="button" type="button" onclick="javascript:history.back(1)"></p>
	...
	<span class="sidebar_bottom"><!-- needed for smooth end of sidebar background--></span>
		...
		<h3>ARIZA FAZURA BINTI ARIFFIN</h3>
		<h3>Menu Pengguna</h3>
			<ul class="submenu">
