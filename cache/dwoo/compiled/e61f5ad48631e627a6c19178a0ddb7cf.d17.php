<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><h3>Selamat datang, Abdulhamdan Bin Ramali (abdulhamdan21@yahoo.com)</h3>	
<form method="POST" action="user-edit-exec" name="update" id="update" class="ajax_form">
    <input type="hidden" name="ic" id="ic" value="880508525069"/>
	
	<div class="notification information"><p>Ubah maklumat peribadi dan biodata</p></div>
	
    <h3>Maklumat Peribadi</h3>
		<p>
			<input name="name" type="text" class="text_input" value="ABDULHAMDAN BIN RAMALI"/>
			<label>Nama Penuh</label>
		</p>
		<p>
			<input name="ic" type="text" class="text_input" value="880508525069"/>
		...
		<p>
			<input name="umur" type="text" class="text_input" value="22" maxlength="2"/>
			<label>Umur</label>
		</p>
	 
    <h3>Maklumat Untuk Dihubungi</h3>
		<p>
			<input name="tel_bimbit" type="text" class="text_input" id="tel_bimbit" value="+60138383345"/>
		...
		<p>
			<textarea name="address" cols="40" rows="5" class="text_input" id="address">NO 44 LOT 4794,LORONG 3 RESETTLEMENT SEHEME STUTONG BARU, 93350 KUCHING SARAWAK.</textarea>
			<label>Alamat Rumah</label>
		</p>
		<p>
			<input name="email" type="text" class="text_input" id="email" value="abdulhamdan21@yahoo.com" />
			<label>E-mail</label>
		</p>
