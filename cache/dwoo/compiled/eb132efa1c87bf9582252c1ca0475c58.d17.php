...
<title>Peta Laman | E-Latihan</title>
...
<script type="text/javascript" src="/application/assets/js/custom.js"></script>
		...
		<link rel="canonical" href="http://elearn.mardi.gov.my/peta-laman" />
...
<p><p><a href="http://elearn.mardi.gov.my/">Halaman Utama</a></p>
<p>Kursus</p>
	<ul style="padding-left:20px">
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/kursus/berjadual" target="">Kursus Berjadual</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/kursus/luar_jadual" target="">Kursus Luar Jadual</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/login" target="">Login</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/pendaftaran" target="">Pendaftaran</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/reset" target="">Reset kata laluan</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/photos" target="">Galeri Kursus</a></li>
	
	</ul>

<p>Tentang Kami</p>
	<ul style="padding-left:20px">
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/pengenalan" target="">Pengenalan</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/misi-dan-objektif" target="">Misi dan Objektif</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/kemudahan" target="">Kemudahan</a></li>
	
		<li style="padding-left:20px">Kemudahan Amali      
			<ul>
				<li><a title="Kuliah" href="http://elearn.mardi.gov.my/kemudahan/kuliah">Dewan Kuliah</a></li>
				<li><a title="Makmal Komputer" href="http://elearn.mardi.gov.my/kemudahan/makmal-komputer">Makmal Komputer</a></li>
				<li><a title="Ladang" href="http://elearn.mardi.gov.my/kemudahan/ladang">Ladang</a></li>
				<li><a title="Ladang" href="http://elearn.mardi.gov.my/kemudahan/ladang">Makmal dan Testbed</a></li>
			</ul>
		</li>
		<li style="padding-left:20px">Kemudahan Lain      
			<ul>
				<li><a title="Penginapan" href="http://elearn.mardi.gov.my/kemudahan/penginapan">Penginapan</a></li>
				<li><a title="Kafeteria" href="http://elearn.mardi.gov.my/kemudahan/kafeteria">Kafeteria</a></li>
				<li><a title="Surau" href="http://elearn.mardi.gov.my/kemudahan/sukan-dan-riadah">Surau</a></li>
				<li><a title="Riadah" href="http://elearn.mardi.gov.my/kemudahan/surau">Riadah</a></li>
				<li><a title="Pengangkutan" href="http://elearn.mardi.gov.my/kemudahan/pengangkutan">Pengangkutan</a></li>
			</ul>
		</li>
	</ul>
...
<p>Maklumat Umum</p>
	<ul style="padding-left:20px">
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/maklumat-umum" target="">Keterangan</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/maklumat-umum/pengesahan-status-permohonan" target="">Pengesahan Status Permohonan</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/maklumat-umum/kaedah-pembayaran" target="">Kaedah Pembayaran</a></li>
			<li style="padding-left:20px"><a href="http://elearn.mardi.gov.my/maklumat-umum/jenis-perkhidmatan" target="">Jenis Perkhidmatan</a></li>
	
	</ul>
<p><a href="http://elearn.mardi.gov.my/hubungi">Hubungi Kami</a></p></p>
