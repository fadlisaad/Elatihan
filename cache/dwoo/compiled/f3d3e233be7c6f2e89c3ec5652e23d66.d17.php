...
<p><h3>Selamat datang, MOHD FADLI SAAD</h3>
...
<h3>Maklumat Untuk Dihubungi</h3>
    <table width="100%">
      ...
      <tr>
        ...
        <td>CASMARIA APARTMENT, JALAN SAMUDRA UTAMA, TAMAN SAMUDRA 61800 BATU CAVES SELANGOR</td>
      </tr>
      <tr>
        <td width="150"><label for="label">E-mail</label></td>
        <td>fadlisaad@apadmedia.com</td>
      </tr>
    </table>
...
<h3>Maklumat Majikan</h3>
  ...
  <tr>
    ...
    <td>APADMEDIA RESOURCES</td>
  </tr>
  <tr>
    <td width="150"><label>Alamat</label></td>
    <td>P.O BOX 252 GOMBAK 53800 KUALA LUMPUR</td>
  </tr>
  <tr>
