<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><h3>Selamat datang, MUR SHAZWANI BINTI OSMAN (shazshazos@yahoo.com)</h3>	
<form method="POST" action="user-edit-exec" name="update" id="update" class="ajax_form">
    <input type="hidden" name="ic" id="ic" value="910402135286"/>
	
	<div class="notification information"><p>Ubah maklumat peribadi dan biodata</p></div>
	
    <h3>Maklumat Peribadi</h3>
		<p>
			<input name="name" type="text" class="text_input" value="NUR SHAZWANI BINTI OSMAN"/>
			<label>Nama Penuh</label>
		</p>
		<p>
			<input name="ic" type="text" class="text_input" value="910402135286"/>
		...
		<p>
			<input name="umur" type="text" class="text_input" value="19" maxlength="2"/>
			<label>Umur</label>
		</p>
	 
    <h3>Maklumat Untuk Dihubungi</h3>
		<p>
			<input name="tel_bimbit" type="text" class="text_input" id="tel_bimbit" value="+60178079025"/>
		...
		<p>
			<textarea name="address" cols="40" rows="5" class="text_input" id="address">LOT 1656 LORONG JUARA 1E
TAMAN SUKMA
93050 KUCHING 
SARAWAK</textarea>
		...
		<p>
			<input name="email" type="text" class="text_input" id="email" value="shazshazos@yahoo.com" />
			<label>E-mail</label>
		</p>
	...
	<h3>Maklumat Lain</h3>
		...
		<p>
			...
			<option value="tiada" selected="selected" selected="selected">- sila pilih -</option>
