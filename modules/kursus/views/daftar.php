...
// echo "<div class='notification information canhide'><p><strong>Pertama kali mendaftar?</strong>Sila isi maklumat di bawah. Jika anda telah mendaftar, <a href='".BASE_URL."user/login'>sila login</a>.</p></div>";

$attributes = array('id' => 'daftar-kursus', 'class' => 'ajax_form');
echo form_open('kursus/'.$this->router->class.'/daftar', $attributes);

// Fieldset
echo form_fieldset('Pendaftaran untuk kursus '.$this->session->userdata('nama_kursus'));
...
echo '<p class="">'.form_input($my_name).form_label('Nama Penuh', 'name').'</p>';
...
echo '<p class="">'.form_input($my_ic).form_label('No Kad Pengenalan', 'ic').'</p>';
...
echo '<p class="">'.form_password($my_password).form_label('Kata Laluan', 'password').'</p>';
...
$my_emel = array('name' => 'emel', 
                ...
                'value' => '',
                'class' => 'text_input is_required');
echo '<p>'.form_input($my_emel).form_label('Emel', 'emel').'</p>';
...
echo '<p class="">'.form_textarea($my_address).'</p>';
...
echo '<p class="">'.form_dropdown('jantina', $jantina, 'none')
...
echo '<p class="">'.form_dropdown('status_perkahwinan', $status_perkahwinan, 'none')
...
echo '<p class="">'.form_dropdown('my_kelulusan', $my_kelulusan, 'none')
...
echo '<p class="">'.form_dropdown('my_pekerjaan', $my_pekerjaan, 'none')
