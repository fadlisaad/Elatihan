...
return array(
	...
	'i:safe_mode_ok' => 'The server&amp;#180;s configuration is correct for safe_mode = Off.',
	...
	'i:erros' => array(
		...
		'15' => 'The indicated user hasn&amp;#180;t got access to the database',
	...
	'i:aviso_default' => '<strong>WARNING:</strong> In the folder data/conf/ there are a file named "default-example.inc.php" that should be renamed to default.inc.php before to continue with the installation.<br /><br />If you are updating a previous installation, check the differences bettwen the files and add the lines from the new config file that not exists in the older config file.',
);
?>